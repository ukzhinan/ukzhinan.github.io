...
指南各章里散落着不少能省钱的渠道，这一页把它们集中列出来，方便你落地后按需要一次办齐。每一项都注明了**适合谁用**和**在指南哪一节有详细说明**——想了解操作细节，点进对应章节看。
...
| 服务 | 类型 | 适合谁 |
| --- | --- | --- |
| [giffgaff](https://giffgaff.com/orders/affiliate/steven_dai?app=1) | 虚拟运营商（O2 网络） | 刚到英国的过渡期，无合约可随时更换 |
| [Virgin Media](https://aklam.io/gmY1NK) | 宽带 | 已搬入固定住所、需要办家庭宽带 |

<h2 id="sec-3">水电与家庭账单</h2>

私人租房通常需要自己开通水电网——详见 [1.1 住宿选择与适应]({{ '/shenghuo/zufang/' | relative_url }})。

| 服务 | 类型 | 适合谁 |
| --- | --- | --- |
| [Octopus Energy](https://share.octopus.energy/peach-snake-892) | 电力供应商 | 私人租房、需要自己开通电力账户 |

<h2 id="sec-4">购物返现平台</h2>

这几个平台是「买之前先过一道」的思路：同样的东西、同样的价格，从返现平台跳转过去能拿回一部分。日常网购频率高的话，一年下来不是小数目——详见 [1.2 饮食与超市采购]({{ '/shenghuo/yinshi-jiankang/' | relative_url }})。
...
| 服务 | 说明 | 适合谁 |
| --- | --- | --- |
| [穿梭 Transocks](https://www.transocks.com/payment?affiliate-code=m3ja4mw) | 回国线路，用于访问腾讯视频、爱奇艺等国内服务 | 想继续看国内影音平台 |

> **关于金额**：上表只写了各服务「是什么、适合谁」，没有写具体返现或推荐奖励金额——这些各家会随时调整，写死在页面上很快就会过期，请以点进去后对方页面显示的为准。套餐价格、Railcard 年费等同理，以官方最新信息为准。
